window.onload = function()
{
    ...
    */
    ...
    //    console.log("Respuesta Horizontal:" + respustaMatriz.horizontal);
    //    console.log("Respuesta Vertical:" + respustaMatriz.vertical);
      ...
      //  console.log("ecuacion horizontal: "+respuesta.horizontal.ecuacion);
      //  console.log("ecuacion vertical: " +respuesta.vertical.ecuacion);


     //  if ((eval(respuesta.horizontal.ecuacion)===respustaMatriz.horizontal)||eval(respuesta.vertical.ecuacion)===respustaMatriz.vertical) 
     //    {
           
     //         $("#"+respuesta.horizontal.div).addClass('verde');
     //         $("#"+respuesta.vertical.div).addClass('verde');
     //    }
     //    else
     //    {
     //        $("#"+respuesta.horizontal.div).removeClass('verde');
     //        $("#"+respuesta.vertical.div).removeClass('verde');
     //    }
     
        if (eval(respuesta.horizontal.ecuacion)===respustaMatriz.horizontal)
     {
        $("#"+respuesta.horizontal.div).removeClass('rojo');
        $("#"+respuesta.horizontal.div).addClass('verde');
     }
     else
     {
        $("#"+respuesta.horizontal.div).removeClass('verde');
        $("#"+respuesta.horizontal.div).addClass('rojo');        
     }
     ...
     {
        $("#"+respuesta.vertical.div).removeClass('rojo');
        $("#"+respuesta.vertical.div).addClass('verde');
     }
     else
     {
        $("#"+respuesta.vertical.div).removeClass('verde');
        $("#"+respuesta.vertical.div).addClass('rojo');
     ...
     if ((eval(respuesta.horizontal.ecuacion)===respustaMatriz.horizontal)&&eval(respuesta.vertical.ecuacion)===respustaMatriz.vertical) 
        {
            ...
            function myFunction () 
            {
                ...
                ({   title: "!Congratulations!",   
                    text: "Matriz Resuelta",   
                    imageUrl: "images/mano.ico",   
                    showCancelButton: false,   
                    closeOnConfirm: false,   
                    showLoaderOnConfirm: true,
                    confirmButtonColor: "#9CCE5F",   
    ...
    var eventosInputs = function()
    {
        ...
        for (var i = 0; i < inputs.length; i++)
        {
            ...
            {
               // console.log(this.id) //Casilla de la matriz que cambia el usuario
